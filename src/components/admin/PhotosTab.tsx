...
const PHOTO_GROUPS: PhotoGroup[] = [
  ...
  },
  {
    label: "Sections",
    photos: [
      { path: "/images/sections/urgence-card.png", filename: "sections/urgence-card.png", usage: "Section depannage urgent + realisation depannage-lanester (avant)" },
  ...
  },
  {
    ...
    photos: [
      ...
      { path: "/images/pages/renovation-douche-italienne.jpeg", filename: "pages/renovation-douche-italienne.jpeg", usage: "Page douche italienne + realisation douche-ploemeur" },
      { path: "/images/pages/renovation-pmr.jpeg", filename: "pages/renovation-pmr.jpeg", usage: "Page salle de bain PMR + realisation sdb-pmr-queven" },
  ...
  },
  {
    ...
    photos: [
      { path: "/images/realisations/sdb-villeurbanne-before.jpeg", filename: "realisations/sdb-villeurbanne-before.jpeg", usage: "Salle de bain Ploemeur — avant travaux" },
      { path: "/images/realisations/cuisine-lyon3-before.png", filename: "realisations/cuisine-lyon3-before.png", usage: "Cuisine Lorient — avant travaux" },
      { path: "/images/realisations/chauffe-eau-caluire-before.png", filename: "realisations/chauffe-eau-caluire-before.png", usage: "Chauffe-eau Larmor-Plage — avant travaux" },
      { path: "/images/realisations/pac-bron-before.jpeg", filename: "realisations/pac-bron-before.jpeg", usage: "Carrelage sejour Caudan — avant travaux" },
      { path: "/images/realisations/sdb-pmr-lyon6-before.jpeg", filename: "realisations/sdb-pmr-lyon6-before.jpeg", usage: "SDB PMR Queven — avant travaux" },
      { path: "/images/realisations/chaudiere-tassin-before.png", filename: "realisations/chaudiere-tassin-before.png", usage: "Plomberie Hennebont — avant travaux" },
      { path: "/images/realisations/douche-lyon7-before.png", filename: "realisations/douche-lyon7-before.png", usage: "Faience SDB Guidel — avant travaux" },
      { path: "/images/realisations/plancher-chauffant-ecully-before.png", filename: "realisations/plancher-chauffant-ecully-before.png", usage: "Douche italienne Pont-Scorff — avant travaux" },
      { path: "/images/realisations/sdb-complete-oullins-before.png", filename: "realisations/sdb-complete-oullins-before.png", usage: "Carrelage terrasse Gestel — avant travaux" },
    ],
  },
  {
    label: "Realisations — Apres",
    photos: [
      { path: "/images/realisations/sdb-villeurbanne-after.png", filename: "realisations/sdb-villeurbanne-after.png", usage: "Salle de bain Ploemeur — apres travaux" },
      { path: "/images/realisations/cuisine-lyon3-after.jpeg", filename: "realisations/cuisine-lyon3-after.jpeg", usage: "Cuisine Lorient — apres travaux" },
      { path: "/images/realisations/chauffe-eau-caluire-after.png", filename: "realisations/chauffe-eau-caluire-after.png", usage: "Chauffe-eau Larmor-Plage — apres travaux" },
      { path: "/images/realisations/pac-bron-after.png", filename: "realisations/pac-bron-after.png", usage: "Carrelage sejour Caudan — apres travaux" },
      { path: "/images/realisations/depannage-lyon2-after.png", filename: "realisations/depannage-lyon2-after.png", usage: "Depannage Lanester — apres travaux" },
    ],
  },
];
