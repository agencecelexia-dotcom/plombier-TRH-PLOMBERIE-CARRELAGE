    ...
    <Link href="/" className={cn("flex items-center gap-2.5 group", className)}>
      <div className="relative shrink-0 transition-transform duration-300 group-hover:scale-105">
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Pipe / wrench icon */}
          <rect x="4" y="4" width="28" height="28" rx="8" fill={light ? "oklch(0.22 0.08 210)" : "oklch(0.22 0.08 210)"} opacity="0.12" />
          <path
            ...
            fill={light ? "oklch(0.64 0.18 30)" : "oklch(0.22 0.08 210)"}
          />
          <circle cx="18" cy="11.5" r="1.5" fill={light ? "white" : "oklch(0.64 0.18 30)"} />
          <circle cx="22" cy="11.5" r="1.5" fill={light ? "white" : "oklch(0.64 0.18 30)"} />
        </svg>
      </div>
      <div>
        <p
